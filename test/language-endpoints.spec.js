...
describe.only("Language Endpoints", function () {
            ...
            describe(endpoint.title, () => {
                ...
                it(`responds with 404 if user doesn't have any languages`, () => {
                    return endpoint
                        ...
                        .set(
                            "Authorization",
                            helpers.makeAuthHeader(testUsers[1])
                        )
                        .send({})
                        .expect(404, {
        ...
        it(`responds with 200 and user's language and words`, () => {
            return supertest(app)
                ...
                .expect((res) => {
                    ...
                    expect(res.body.language).to.have.property("head").which.is
                        .not.null;
    ...
    describe(`GET /api/language/head`, () => {
        const usersLanguage = testLanguages.find(
            (l) => l.user_id === testUser.id
        );
        const headWord = testWords.find(
            (w) => w.language_id === usersLanguage.id
        );
